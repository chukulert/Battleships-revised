...
describe('Setup functions', ()=>{
    ...
    test('add ships to board array',()=>{
        ...
        expect(gamePlay.data.gameboards.playerBoard.ships[0]).toMatchObject({ name: 'destroyer', shipLength: 2, coords: [], direction : 'vertical', sunk : false })
        expect(gamePlay.data.gameboards.computerBoard.ships[0]).toMatchObject({ name: 'destroyer', shipLength: 2, coords: [], direction : 'vertical', sunk : false })
    })
})
